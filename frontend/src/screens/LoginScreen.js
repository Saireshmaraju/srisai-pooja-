...
import FormContainer from '../components/FormContainers'
 ...
 const LoginScreen = ({location,history}) => {
    ...
    return (
        <FormContainer>
            <h1>Sign in to Sri Sai Pooja Stores</h1>
            ...
            <Form onSubmit={submitHandler}>
                ...
                <Form.Group controlId='password'>
                    ...
                    <Form.Control type='password' placeholder='Enter Email address' value={password} onChange={(e)=>setPassword(e.target.value)}>
                    </Form.Control>
                </Form.Group>
